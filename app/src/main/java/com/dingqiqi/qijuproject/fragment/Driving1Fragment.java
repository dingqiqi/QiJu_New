 ...
 */
public class Driving1Fragment extends BaseFragment {
...
//    private TextView mTvNext;
    ...
    public View createView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_driving1_layout, container, false);
    }
    ...
    public void initView(View view) {
        ...
        mTvTitle = (TextView) view.findViewById(R.id.tv_title_driving1);
        mIvShow = (ImageView) view.findViewById(R.id.iv_show_driving1);
        mRbItemA = (RadioButton) view.findViewById(R.id.rb_item_a_driving1);
        mRbItemB = (RadioButton) view.findViewById(R.id.rb_item_b_driving1);
        mRbItemC = (RadioButton) view.findViewById(R.id.rb_item_c_driving1);
        mRbItemD = (RadioButton) view.findViewById(R.id.rb_item_d_driving1);
        mTvOk = (TextView) view.findViewById(R.id.tv_yes_driving1);
        mTvDetail = (TextView) view.findViewById(R.id.tv_detail_driving1);
        mTvBack = (TextView) view.findViewById(R.id.tv_back_driving1);
        TextView mTvNext = (TextView) view.findViewById(R.id.tv_next_driving1);
        TextView mTvError = (TextView) view.findViewById(R.id.tv_error_driving1);
        mRadioGroup = (RadioGroup) view.findViewById(R.id.rg_item_driving1);
...
//            ToastUtil.showToast("加载科目一数据");
    ...
    private void requestData(final boolean isFirst) {
        IDriving1Api driving1Api = RetrofitManager.getInstance(getActivity()).getRetrofit().create(IDriving1Api.class);
        Log.i("aaa", "当前页 " + String.valueOf(mCurPage) + "页大小 " + String.valueOf(mPageSize));
        Call<DrivingMode> call = driving1Api.getDriving1Data(CommonUtil.getKey(), String.valueOf(mCurPage), String.valueOf(mPageSize));
