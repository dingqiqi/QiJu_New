...
import com.dingqiqi.qijuproject.http.IDrivingOtherQueryApi;
 ...
 */
public class DrivingBaseFragment extends BaseFragment {
...
//    private TextView mTvNext;
    ...
    public View createView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_driving_base_layout, container, false);
    }
    ...
    public void initView(View view) {
        ...
        mTvTitle = (TextView) view.findViewById(R.id.tv_title_driving_base);
        mIvShow = (ImageView) view.findViewById(R.id.iv_show_driving_base);
        mRbItemA = (RadioButton) view.findViewById(R.id.rb_item_a_driving_base);
        mRbItemB = (RadioButton) view.findViewById(R.id.rb_item_b_driving_base);
        mRbItemC = (RadioButton) view.findViewById(R.id.rb_item_c_driving_base);
        mRbItemD = (RadioButton) view.findViewById(R.id.rb_item_d_driving_base);
        mTvOk = (TextView) view.findViewById(R.id.tv_yes_driving_base);
        mTvDetail = (TextView) view.findViewById(R.id.tv_detail_driving_base);
        mTvBack = (TextView) view.findViewById(R.id.tv_back_driving_base);
        TextView mTvNext = (TextView) view.findViewById(R.id.tv_next_driving_base);
        TextView mTvError = (TextView) view.findViewById(R.id.tv_error_driving_base);
        mRadioGroup = (RadioGroup) view.findViewById(R.id.rg_item_driving_base);
    ...
    private void setData() {
        ...
        if (TextUtils.isEmpty(mMode.getA())) {
            String text = "A、正确";
        ...
        String text = "正确解释:" + mMode.getExplainText();
        //设置正确答案解释
...
//            ToastUtil.showToast("加载科目一数据");
    ...
    private void requestData(final boolean isFirst) {
        IDrivingOtherQueryApi driving1Api = RetrofitManager.getInstance(getActivity()).getRetrofit().create(IDrivingOtherQueryApi.class);
        Log.i("aaa", "当前页 " + String.valueOf(mCurPage) + "页大小 " + String.valueOf(mPageSize));
        Call<DrivingMode> call = driving1Api.getDriving1Data(CommonUtil.getKey(), String.valueOf(mCurPage), String.valueOf(mPageSize), mCId);
    ...
    private void showExitDialog() {
        mDialogFragment = DialogFactory.getInstance().showTwoBtnDialog(getActivity().getSupportFragmentManager(), "系统提示",
                "您正在进行科目一驾照模拟考试练习,是否退出练习?", "", "", new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        mDialogFragment.dismiss();
                        getActivity().finish();
