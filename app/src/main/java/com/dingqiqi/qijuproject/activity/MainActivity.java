...
import com.dingqiqi.qijuproject.activity.itemActivity.DictionaryActivity;
import com.dingqiqi.qijuproject.activity.itemActivity.DrivingTitleActivity;
import com.dingqiqi.qijuproject.activity.itemActivity.IdiomActivity;
import com.dingqiqi.qijuproject.activity.itemActivity.MenuListActivity;
import com.dingqiqi.qijuproject.activity.itemActivity.PhoneNumAttributionActivity;
import com.dingqiqi.qijuproject.activity.itemActivity.PuzzleActivity;
import com.dingqiqi.qijuproject.activity.itemActivity.TrainDetailActivity;
import com.dingqiqi.qijuproject.activity.itemActivity.WXFilterActivity;
...
//    private int mPointWidth = 0;
    ...
    //变形的view
    private TestRadiusView mRadiusView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mItemData = new Class[]{WeatherActivity.class, DrivingTitleActivity.class, TrainDetailActivity.class
                , IdiomActivity.class, DictionaryActivity.class, PuzzleActivity.class, PhoneNumAttributionActivity.class
                , MenuListActivity.class, WXFilterActivity.class};
    }
    ...
    private void initView() {
        ...
        mRadiusView = (TestRadiusView) navigationView.getHeaderView(0).findViewById(R.id.radiusView);
        SeekBar seekBar = (SeekBar) navigationView.getHeaderView(0).findViewById(R.id.seekBar);
        seekBar.setMax(100);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                mRadiusView.setRadius(progress);
            }
...
//                });
    ...
    protected void onStart() {
        super.onStart();
        mMarqueeView.startRun();
    }

    @Override
    protected void onStop() {
        super.onStop();
        mMarqueeView.stopRun();
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        CustomApplication.getInstance().onDestroy();
        System.exit(0);
    }
}
