...
public class GlideModuleManager implements GlideModule {
    ...
    public final static String DISKCACHE_PATH = "/GlideCache";   // 磁盘缓存路径
    public final static int DISKCACHE_SIZE = 30 * 1024 * 1024;// 磁盘缓存大小(当前30M)
    ...
    public void applyOptions(Context context, GlideBuilder builder) {
        ...
        //设置磁盘路径和缓存大小
        final String diskFullPath = CommonUtil.getWritePath(DISKCACHE_PATH);

        builder.setDiskCache(new DiskLruCacheFactory(diskFullPath, "glide", DISKCACHE_SIZE));
    }
